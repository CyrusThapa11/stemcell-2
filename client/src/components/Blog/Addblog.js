  ...
  return (
    <>
      <div className="container my-5 fund px-28 py-20 ">
        <h5 className="text-gray-900 font-bold text-xl mb-2 text-center">
          Add New Blog
        </h5>

        <div class="input-group my-3 flex flex-col gap-1 w-[20vw] ">
        ...
        <div className="flex flex-row-reverse items-center mx-auto my-3 ">
          <button
            type="button"
            onClick={handleSave}
            style={{ background: "#c536ab", borderRadius: "10px" }}
            className="btn btn-info  text-white w-[15vw] "
          >
            Save
          </button>
        </div>
